        ...
        >
            ...
            <div className="flex justify-between items-start mb-10 border-b-2 pb-6" style={{ borderColor: brandColor }}>
                ...
                <div className="text-right">
                    <div className="px-5 py-2 bg-gray-900 text-white mb-2 inline-block rounded-sm font-black uppercase tracking-widest text-lg">
                        Test Statement
                    </div>
                    <p className="text-xs font-black text-gray-400 uppercase tracking-widest leading-none mt-2">
            ...
            <div className="flex gap-10 mb-10">
                <div className="flex-1 space-y-4">
                    <div>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-1">Learner Particulars</p>
                        <h3 className="text-3xl font-black text-gray-800 uppercase italic leading-tight border-b-2 border-gray-900 pb-1">
                            {learner.firstName} {learner.lastName}
                        </h3>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Admission Number</p>
                            <p className="text-lg font-black text-gray-800">{learner.admissionNumber}</p>
                        </div>
                        <div>
                            <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Grade Level</p>
                            <p className="text-lg font-black text-gray-800 uppercase">{learner.grade}</p>
                        </div>
                    </div>
                </div>
                <div className="w-1/3 bg-gray-50 border border-gray-200 rounded-xl p-6 flex flex-col justify-center text-center shadow-inner">
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 font-black">Assessment Topic</p>
                    <h4 className="text-xl font-black text-indigo-900 uppercase leading-tight mb-2">
                        {testData.test?.learningArea || 'Learning Area'}
                    </h4>
                    <div className="inline-block px-3 py-1 bg-white border border-gray-300 rounded font-black text-[10px] text-gray-600 uppercase tracking-widest">
            ...
            <div className="mb-12 border-2 border-gray-900 rounded-lg overflow-hidden flex shadow-2xl">
                <div className="flex-1 p-10 flex flex-col items-center justify-center text-center text-white" style={{ backgroundColor: brandColor }}>
                    <p className="text-xs font-black uppercase tracking-widest opacity-80 mb-4">Performance Rank</p>
                    <div className="text-8xl font-black italic tracking-tighter mb-2">{testData.grade || (testData.percentage >= 80 ? 'A' : testData.percentage >= 60 ? 'B' : testData.percentage >= 50 ? 'C' : 'D')}</div>
                    <p className="text-lg font-black uppercase tracking-[0.3em] font-bold">Grade Level</p>
                </div>
                ...
                <div className="flex-[2] p-10 bg-white grid grid-cols-2 gap-10">
                    <div className="space-y-1">
                        ...
                        <p className="text-5xl font-black text-gray-900">
                            {testData.marksObtained} <span className="text-sm text-gray-400 font-bold tracking-normal italic">/ {testData.test?.totalMarks || 100}</span>
                        </p>
                    </div>
                    <div className="space-y-1">
                    ...
                    <div className="col-span-2 border-t pt-6 grid grid-cols-2">
                        <div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Class Position</p>
                            <p className="text-2xl font-black text-gray-900">
                                {testData.position || '--'} <span className="text-[10px] text-gray-400 font-bold tracking-normal uppercase italic">out of {testData.outOf || '--'}</span>
                            </p>
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Performance Status</p>
                            <p className={`text-2xl font-black ${testData.percentage >= 50 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="bg-gray-50 p-8 rounded border border-gray-200 mb-10 border-l-8" style={{ borderLeftColor: brandColor }}>
                <h3 className="text-xs font-black text-gray-900 uppercase tracking-[0.2em] mb-4">Instructor Feedback</h3>
                <p className="text-xl font-bold italic text-gray-700 leading-relaxed">
            ...
            <div className="mt-auto pt-10 border-t border-dashed border-gray-300 grid grid-cols-2 gap-20">
                ...
                <div className="text-center">
                    ...
                    <p className="text-[9px] font-black text-gray-500 uppercase tracking-widest mt-2">Parent / Guardian Acknowledgement</p>
                </div>
            </div>

            {/* SUB-FOOTER */}
            <div className="mt-8 text-center text-gray-300 border-t border-gray-50 pt-4">
                <p className="text-[8px] font-black uppercase tracking-[0.5em] mb-2 leading-none">Internal Academic Document - Not a Permanent Certificate</p>
