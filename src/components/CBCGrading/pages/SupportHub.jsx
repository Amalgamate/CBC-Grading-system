    ...
    },
    {
      ...
      articles: [
        ...
        },
        {
          ...
          content: 'Go to Settings → Communication Settings → SMS tab. Select provider (Africa\'s Talking for Kenya at KES 0.80/SMS recommended). For Africa\'s Talking: Use "sandbox" as username for free testing, or create account for production. Enter API key and set Sender ID (max 11 characters, e.g., ZAWADI). Save and test with a phone number in format 254712345678.'
        },
        {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <a
          href="mailto:support@zawadijrn.ac.ke"
