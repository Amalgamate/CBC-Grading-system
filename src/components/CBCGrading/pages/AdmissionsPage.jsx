                ...
                <div className="border-t pt-6 mt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <div>
                      ...
                      <input type="date" name="dateOfAdmission" value={formData.dateOfAdmission} disabled={true} className="w-full px-3 py-2 bg-gray-100 border border-gray-200 rounded-md text-sm shadow-sm cursor-not-allowed font-mono text-gray-600" />
