 ...
 * Modal for adding or editing teacher/tutor information
 */
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> The tutor will be created with the role "TEACHER" and can access the system using their email and password.
              </p>
            </div>
          </div>
        </form>
