            ...
            <div className="bg-white">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div className="space-y-10">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#f4f0f2] border border-[#d9ccd5] rounded-full">
                                    <Sparkles className="w-4 h-4 text-[#520050]" />
                                    <span className="text-xs font-bold text-[#520050] uppercase tracking-wider">The Innovation Hub</span>
                                </div>
                                <h1 className="text-5xl md:text-7xl font-bold text-brand-dark leading-[1.1] tracking-tight">
                                    Where <span className="text-[#520050]">Curiosity</span> Leads to <span className="text-teal-600 font-light italic">Creation</span>.
                                </h1>
                                ...
                                <div className="flex flex-wrap gap-4 pt-4">
                                    <button onClick={props.onGetStartedClick} className="bg-[#520050] hover:bg-[#3D0038] text-white px-8 py-4 rounded-2xl font-bold shadow-xl transition-all hover:-translate-y-1 flex items-center gap-2">
                                        Explore the Experience <ArrowRight size={20} />
                                    </button>
                                    <button className="bg-white border-2 border-slate-200 hover:border-[#520050] text-slate-700 px-8 py-4 rounded-2xl font-bold transition-all flex items-center gap-2">
                                        Watch the Method <Play size={20} className="text-[#520050]" />
                                    </button>
                                </div>
                            </div>
                ...
                <section className="py-32 bg-brand-dark relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-full opacity-10">
                        <div className="absolute inset-0 bg-[radial-gradient(#520050_1px,transparent_1px)] [background-size:40px_40px]"></div>
                    </div>
                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                        <div className="w-20 h-20 bg-[#520050]/20 border border-[#520050]/30 rounded-3xl flex items-center justify-center mx-auto mb-10">
                            <Lightbulb className="text-[#520050]" size={40} />
                        </div>
                        ...
                        <div className="h-1 w-24 bg-[#520050] mx-auto rounded-full"></div>
                    </div>
                </section>
                        ...
                        <div className="flex flex-col lg:flex-row gap-20 items-center">
                            <div className="flex-1 space-y-10">
                                <div className="space-y-4">
                                    <h3 className="text-4xl font-bold text-brand-dark tracking-tight">The <span className="text-[#520050]">Block Logic</span> Framework</h3>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    {[
                                        ...
                                        <div key={i} className="flex gap-4 items-center p-4 bg-gray-50 rounded-2xl border border-gray-100">
                                            <div className={`w-10 h-10 ${item.color === 'purple' ? 'bg-[#f4f0f2] text-[#520050]' : 'bg-teal-50 text-teal-600'} rounded-xl flex items-center justify-center`}>
                                                <item.icon size={20} />
                                            </div>
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-6">
                                <div className="bg-[#f4f0f2] rounded-3xl p-10 aspect-[4/5] flex flex-col justify-between hover:shadow-xl transition-all">
                                    <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-lg">
                                        <Code className="text-[#520050]" size={32} />
                                    </div>
                                    <div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                            {[
                                ...
                                <div key={i} className="bg-white rounded-3xl p-10 border border-slate-100 hover:shadow-2xl hover:border-[#520050]/30 transition-all group flex flex-col items-center text-center">
                                    <div className={`w-20 h-20 bg-${tier.color}-50 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}>
                                        <tier.icon className={tier.color === 'purple' ? 'text-[#520050]' : tier.color === 'teal' ? 'text-teal-600' : 'text-blue-500'} size={40} />
                                    </div>
                                    ...
                                    <div className="mt-8 pt-6 border-t border-slate-50 w-full">
                                        <button className="text-[#520050] font-bold text-sm flex items-center justify-center gap-2 mx-auto">
                        ...
                        <div className="flex flex-col lg:flex-row gap-20 items-center">
                            <div className="flex-1">
                                <div className="relative">
                                    ...
                                    <div className="absolute -top-10 -left-10 w-48 h-48 bg-[#520050]/10 rounded-full blur-3xl"></div>
                                </div>
                            </div>
                            <div className="flex-1 space-y-10">
                                <Quote size={60} className="text-[#520050]/20" />
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="w-16 h-16 rounded-2xl bg-[#520050] flex items-center justify-center text-white text-2xl font-bold">JT</div>
                                    <div>
                ...
                <section className="py-32 bg-white">
                    <div className="max-w-5xl mx-auto px-6 text-center">
                        <h2 className="text-4xl md:text-6xl font-bold text-brand-dark mb-8 tracking-tight">
                            Experience the <span className="text-[#520050]">Playroom</span>.
                        </h2>
                        <p className="text-2xl text-slate-500 font-light mb-12">Visit us and see the future of education in action.</p>
                        <div className="flex flex-col sm:flex-row gap-6 justify-center">
                            <button onClick={props.onGetStartedClick} className="px-12 py-5 bg-[#520050] text-white font-bold rounded-2xl shadow-2xl hover:bg-[#3D0038] transition-all hover:-translate-y-1">
