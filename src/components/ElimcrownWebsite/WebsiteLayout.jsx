...
export const WebsiteLayout = ({ children, onLoginClick, onGetStartedClick, isAuthenticated, onOpenAppClick }) => {
    ...
    const navLinks = [
        { name: 'The Playroom', path: '/playroom' },
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        {!isAuthenticated ? (
                            ...
                            <button
                                ...
                                className="bg-brand-teal hover:bg-[#006b70] text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl text-sm font-bold transition-all"
                            >
                                Go to Dashboard
                            </button>
                        )}
                        ...
                        <div className="md:col-span-1">
                            <div className="flex items-center mb-4">
                                <h4 className="text-xl tracking-tight">
                                    <span className="font-black text-white">Elim</span>
                                    <span className="font-normal text-teal-200">crown</span>
                                </h4>
                            </div>
