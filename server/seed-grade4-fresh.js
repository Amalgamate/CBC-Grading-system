...
// Grade 4 Summative Scores - Fresh data (32 students only)
...
async function seedGrade4Fresh() {
  try {
    console.log('\n' + '═'.repeat(130));
    console.log('🌱 SEEDING GRADE 4 SUMMATIVE SCORES - FRESH START (32 STUDENTS ONLY)');
    ...
    console.log(`📊 Database has ${grade4Learners.length} existing Grade 4 students`);
    ...
    console.log('─'.repeat(130));
    console.log(`✅ Successfully seeded: ${successCount}/${grade4SummativeData.length}`);
